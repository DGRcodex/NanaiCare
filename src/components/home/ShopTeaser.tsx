    ...
    <section id="shop" className="scroll-mt-28 px-4 pb-24 pt-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-nanai-ink text-white shadow-nanai-soft ring-1 ring-white/10">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative h-72 w-full sm:h-96 lg:h-full lg:min-h-[500px]">
            <img 
              src="/images/shop/curated_products.png" 
              alt="Curated Products" 
              className="absolute inset-0 h-full w-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-nanai-ink/80 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-nanai-ink/50 lg:to-nanai-ink" />
          </div>
