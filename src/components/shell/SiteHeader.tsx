  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/50 bg-nanai-frost/80 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="group flex items-center gap-3 rounded-full pr-3 outline-offset-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-nanai-sage">
        ...
        <nav
          className="hidden items-center gap-8 text-sm font-semibold tracking-wide text-nanai-ink/75 md:flex"
          aria-label="Primary"
        >
          <a className="transition hover:text-nanai-ink" href="#services">
            {t("services")}
          </a>
          <a className="transition hover:text-nanai-ink" href="#stories">
            {t("stories")}
          </a>
          <a className="transition hover:text-nanai-ink" href="#wellness">
            {t("wellness")}
          </a>
          <a className="transition hover:text-nanai-ink" href="#shop">
            {t("shop")}
          </a>
        </nav>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <details className="relative md:hidden">
            ...
            <div className="absolute right-0 mt-3 w-52 rounded-2xl border border-nanai-rose/35 bg-white/95 p-2 text-sm font-semibold shadow-nanai-soft backdrop-blur-xl">
              <a className="block rounded-xl px-3 py-2 hover:bg-nanai-blush/60" href="#services">
                {t("services")}
              </a>
              <a className="block rounded-xl px-3 py-2 hover:bg-nanai-blush/60" href="#stories">
                {t("stories")}
              </a>
              <a className="block rounded-xl px-3 py-2 hover:bg-nanai-blush/60" href="#wellness">
                {t("wellness")}
              </a>
              <a className="block rounded-xl px-3 py-2 hover:bg-nanai-blush/60" href="#shop">
                {t("shop")}
              </a>
              <a
